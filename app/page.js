...
const content = {
  id: {
    ...
    experience: {
      ...
      projects: [ { title: "Proyek UBMager API", role: "Back-End Developer", year: "2025", description: "Mengembangkan prototipe back-end untuk aplikasi e-commerce jastip menggunakan Laravel API dengan database MySQL. Mengimplementasikan fitur-fitur seperti add to cart, checkout, dan integrasi payment gateway Midtrans Snap (sandbox)." },  { title: "Proyek Jokominto Game", role: "Developer", year: "2025", description: "Mengembangkan antarmuka dan logika permainan untuk game virtual pet 'Jokominto'. Mengimplementasikan fitur-fitur seperti makan, tidur, mandi, dan bermain menggunakan HTML, CSS, dan JavaScript native dengan library XState." }, { title: "Proyek Tokoman", role: "Full Stack Developer", year: "2024", description: "Merancang, mengembangkan, dan memelihara fungsionalitas front-end dan back-end. Membangun aplikasi MVC Laravel yang dilengkapi antarmuka ramah pengguna yang dibuat dengan Tailwind CSS. Berkontribusi dalam proses review kode, pengujian, dan penyebaran." }, { title: "Proyek LibHub", role: "Front-End Developer", year: "2023", description: "Merancang dan mengembangkan antarmuka pengguna (UI) yang intuitif dan responsif. Mengimplementasikan desain fungsional menggunakan HTML, CSS, dan JavaScript, serta bekerja sama dengan tim untuk integrasi dan pengujian." } ],
  ...
  en: {
    ...
    experience: {
      ...
      projects: [ { title: "UBMager API Project", role: "Back-End Developer", year: "2025", description: "Developed a back-end prototype for a 'jastip' e-commerce application using Laravel API with a MySQL database. Implemented features like add to cart, checkout, and Midtrans Snap payment gateway integration (sandbox)." }, { title: "Jokominto Game Project", role: "Developer", year: "2025", description: "Developed the interface and game logic for the 'Jokominto' virtual pet game. Implemented features such as eat, sleep, bath, and play using native HTML, CSS, and JavaScript with the XState library for state management." },{ title: "Tokoman Project", role: "Full Stack Developer", year: "2024", description: "Designed, developed, and maintained both front-end and back-end functionalities. Built a Laravel MVC application with a user-friendly interface created with Tailwind CSS. Contributed to code reviews, testing, and deployment processes." },{ title: "LibHub Project", role: "Front-End Developer", year: "2023", description: "Designed and developed an intuitive and responsive user interface (UI). Implemented functional designs using HTML, CSS, and JavaScript, and collaborated with the team for integration and testing." } ],
